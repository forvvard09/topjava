...
<div class="jumbotron pt-4">
    <div class="container">
            ...
            <div class="card-body pb-0">
                ...
                <div class="card-footer text-right">
                    <button class="btn btn-danger" onclick="clearFilter()">
                        ...
                        <spring:message code="meal.filter.clean"/>
                    </button>
        ...
        <table class="table table-striped" id="meals-datatable">
            <thead>
            <tr>
            ...
            <c:forEach items="${meals}" var="meal">
                ...
                <tr id="${meal.id}" data-mealExcess="${meal.excess}">
                    ...
                    <td>${meal.calories}</td>
                    <td><a><span class="edit fa fa-pencil"></span></a></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="detailsForm">
<%--                    это поле понадобится когда будем реализовывать редактирование--%>
