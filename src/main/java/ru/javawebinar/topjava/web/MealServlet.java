...
import static ru.javawebinar.topjava.util.DateTimeUtil.getDateFomString;
import static ru.javawebinar.topjava.util.DateTimeUtil.getTimeFomString;
...
public class MealServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        log.info(meal.isNew() ? "Controller: Create {}" : "Controller: Update {}", meal);
    ...
    private LocalDateTime getDaysFilterForm(String requestParameter) {
        return getDateFomString(requestParameter);
    }

    private LocalDateTime getTimeFilterForm(String requestParameter) {
        return getTimeFomString(requestParameter);
    }
